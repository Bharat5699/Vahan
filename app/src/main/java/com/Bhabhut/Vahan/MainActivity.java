...
public class MainActivity extends AppCompatActivity {
    ...
    public void register(View view) {
        ...
        ref.child(eRegistration_No.getText().toString().toUpperCase()).addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
                ...
                if (dataSnapshot.exists()) {
                    ...
                    ref.addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            getValue();
                            ref.child(eRegistration_No.getText().toString().toUpperCase()).setValue(user);
    ...
    private  void getValue(){
        ...
        user.setRegistration_No(eRegistration_No.getText().toString().toUpperCase());
